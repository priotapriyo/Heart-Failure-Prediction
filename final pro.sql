...
BEGIN
	...
	SELECT COUNT(Symptoms) INTO B FROM Patient1@site1;
...
BEGIN
	...
	SELECT COUNT(Symptoms) INTO B2 FROM Patient2@site1;
...
BEGIN
	...
	SELECT COUNT(Symptoms) INTO B3 FROM Patient3@site1;
...
BEGIN
	...
	SELECT COUNT(Symptoms) INTO B4 FROM Patient4@site1;
